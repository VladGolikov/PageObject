...
def test_catalog(browser):
    ...
    base.comparing_the_current_address(address='http://172.16.16.249:8081/index.php?route=product'
...
def test_register_user(browser):
    ...
    base.comparing_the_current_address(address='http://172.16.16.249:8081/index.php?route=account'
                                               '/register')
